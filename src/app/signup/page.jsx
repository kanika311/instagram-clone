...
export default function Signup() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white w-[100%]  p-[20px]">
      <div className="bg-white p-8 rounded-lg  w-[30%] border-[1px] border-[#dbdbdb]">
        ...
        <form onSubmit={handleSubmit}  className="space-y-3">
          <input
            ...
            onChange={handleChange}
             onBlur={handleBlur}
            // error={touched.email && Boolean(errors.email)} // Show red border if error
          ...
          <input
            ...
            onChange={handleChange}
             onBlur={handleBlur}
            // error={touched.password && Boolean(errors.password)} // Show red border if error
          ...
          <input
            ...
            onChange={handleChange}
             onBlur={handleBlur}
            // error={touched.name && Boolean(errors.name)} // Show red border if error
          ...
          <input
            ...
            onChange={handleChange}
             onBlur={handleBlur}
            // error={touched.username && Boolean(errors.username)} // Show red border if error
          ...
          <button  type='submit' className="w-full bg-blue-500 text-white py-2 rounded-lg font-bold">Sign up</button>
        </form>
